class jogoDaMemoria{
    ...
    exibirHErois(nomeDoHeroi){
        //vamos procurar esse heroi pelo nome em nosss heroisIniciais
        //vamos obter somente a imagem dele
        const {img} = this.heroiIniciais.find(({nome})=> nomeDoHEroi === nome)
        //vamos criar uma funcao na tela para exibir somente heroi selecionado
        this.yela.exibirHErois(nomeDoHeroi, img)
    }
    jogar(){
